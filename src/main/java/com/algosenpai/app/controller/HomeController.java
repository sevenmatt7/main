...
import com.algosenpai.app.command.CommandEnum;
...
public class HomeController extends SceneController implements Initializable {
    ...
    /**
     * Handle the Command generated by the parseInput function.
     * @param newCommand the command to be executed.
     */
    void handleCommand (Command newCommand) throws IOException {
        switch (newCommand.getType()) {
            case MENU:
